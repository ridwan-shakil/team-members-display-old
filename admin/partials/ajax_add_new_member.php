...
<li class="single-team-member">
	...
	<div class="image-area member-input">
		...
		<button class="select-image-button"><?php _e( 'Upload Image', 'tmdisplay' ); ?></button>
		<p> <?php _e( 'Upload an image by clicking the button', 'team-members-display' ); ?> </p>
	</div>
	<!-- Member description -->
	<div class="description-area member-input">
		<span class="mb_label"><?php _e( 'Member Name', 'team-members-display' ); ?></span>
		<input type="text" name="mb_name[]" value="" class="rs_label_text" required>

		<span class="mb_label"><?php _e( 'Member Designation', 'team-members-display' ); ?></span>
		<input type="text" name="mb_pos[]" value="" class="rs_label_text" required>

		<span class="mb_label"><?php _e( 'Member Small Description', 'team-members-display' ); ?></span>
		<textarea name="mb_desc[]" class="rs_label_text" required></textarea>
	</div>
	<!-- Social accounts -->
	<div class="socials-area member-input">
		<span class="mb_label"><?php _e( 'Add Member Socials', 'team-members-display' ); ?></span>
		<div class="meta_fields">
			<div class="social-repeater">
				...
				<div class="social-row">
					...
					<input type="text" name="first_social_link[]" value="" placeholder=" <?php _e( 'Social Link', 'team-members-display' ); ?>">
				</div>
				<!-- second social  -->
				<div class="social-row">
					...
					<input type="text" name="second_social_link[]" value="" placeholder=" <?php _e( 'Social Link', 'team-members-display' ); ?>">
				</div>
				<!-- third social  -->
				<div class="social-row">
					...
					<input type="text" name="third_social_link[]" value="" placeholder=" <?php _e( 'Social Link', 'team-members-display' ); ?>">
				</div>
				<!-- fourth social  -->
				<div class="social-row">
					...
					<input type="text" name="fourth_social_link[]" value="" placeholder=" <?php _e( 'Social Link', 'team-members-display' ); ?>">
				</div>
