...
function columns_field_callback() {
	...
	<select name="tms_columns" id="tms-columns-select">
		<option value="40%" <?php selected( $selected_columns, '40%' ); ?>><?php _e( '2 Columns', 'team-members-display' ); ?> </option>
		<option value="30%" <?php selected( $selected_columns, '30%' ); ?>><?php _e( '3 Columns', 'team-members-display' ); ?></option>
		<option value="20%" <?php selected( $selected_columns, '20%' ); ?>><?php _e( '4 Columns', 'team-members-display' ); ?></option>
		<option value="15%" <?php selected( $selected_columns, '15%' ); ?>><?php _e( '5 Columns', 'team-members-display' ); ?></option>
	</select>
	<?php
}
...
function custom_css_field_callback() {
	...
	?>
	<p><?php _e( 'Enter your custom css without ', 'team-members-display' ); ?> <strong>&lt;style&gt; &lt;/style&gt; </strong> <?php _e( 'tag. ', 'team-members-display' ); ?></p>
	<p><?php _e( 'Click "Save Changes" to see the effect of your custom css.', 'team-members-display' ); ?></p>
	<?php
}
