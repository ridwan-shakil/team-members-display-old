...
<div class=" style-settings-wrapper">
	<div class="settings-column">
		<h1 class="nav-tab-wrapper">
			<a href=" #" id="content-tab" class="nav-tab"><?php _e( 'Content', 'team-members-display' ); ?></a>
			<a href=" #" id="style-tab" class="nav-tab"><?php _e( 'Style', 'team-members-display' ); ?></a>
			<a href=" #" id="advanced-tab" class="nav-tab"><?php _e( 'Custom CSS', 'team-members-display' ); ?></a>
		</h1>
			...
			for ( $i = 0; $i < 4; $i++ ) {
				...
				<div class="rs-single-team-member">
					...
					<div class="member-info">
						<h3 class="tm-s-name"><?php _e( 'Ridwan', 'team-members-display' ); ?></h3>
						<p class="tm-s-position"><?php _e( 'WordPress developer', 'team-members-display' ); ?></p>
...
<div class="tms_notice">
	<p><?php _e( 'Here are some demo team members . Change the styling and see a visual representation how your team members are going to look  like in the frontend . ', 'team-members-display' ); ?></p>
</div>
