...
// $Team_members = unserialize(get_post_meta($post->ID, 'rs_team_member_display_data', true));
		...
		foreach ( $Team_members as $member ) {
			...
			<li class="single-team-member drag-handle">
				...
				<div class="image-area member-input">
					...
					<button class="select-image-button"><?php _e( 'Upload Image', 'team-members-display' ); ?></button>
...
<div class="controler-container">
	...
	<div class="add-member controler">
		<a href="#" id="add-new-member"> <?php _e( 'Add New Member', 'team-members-display' ); ?> </a>
	</div>
	...
	<div class="delete-all-members controler">
		<a href="#" class="all-delete-btn">
			...
			<?php _e( 'Delete All', 'team-members-display' ); ?>
		</a>
	</div>
</div>
<hr>
...
<div class="tm-display-short-code controler">
	<span><?php _e( 'Use this short code to show this team : ', 'team-members-display' ); ?></span>
