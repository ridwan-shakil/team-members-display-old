 ...
 * @subpackage Team_Members_Showcase/public
 */
 ...
 */
class Team_Members_Showcase_Public {
	...
	public function enqueue_scripts() {
		...
		global $post;
		if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'TEAM_MEMBERS')) {
			wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/team-members-showcase-public.js', array('jquery'), $this->version, false);
